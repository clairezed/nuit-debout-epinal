...
Ceci est le code du site [nuitdeboutepinal.fr](http://www.nuitdeboutepinal.fr/]. Le site est construit sur [Jekyll][Jekyll](http://jekyllrb.com/), générateur de site statiques (= san base de donnée, sans configuration lourde), et utilise une version adaptée du thème [Skinny Bones demo](http://mmistakes.github.io/skinny-bones-jekyll/).
...
**Attention !** Ne pas modifier les intitulés, mais uniquement le contenu (sous peine de faire disparaitre du contenu) !
...
- Une fois cette page affichée, cliquez sur l'icon 'crayon' (entre le bouton 'History' et la poubelle, au sommet du contenu de la page)
